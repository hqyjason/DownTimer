 ...
 * Date:2020/12/14
 */
public class ScrollFloatingButton extends FloatingActionButton {
    ...
    public ScrollFloatingButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ScrollFloatingButton(Context context, AttributeSet attrs, final int defStyleAttr) {
